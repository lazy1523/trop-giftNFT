...
contract GiftURIV1 {
    ...
    function tokenURI(uint256 tokenId, address owner, uint256 value) external view returns (string memory) {
        ...
        string memory json = string(abi.encodePacked('{\'name\':\'Gift(',showValue,') #',tokenId.toString(),'\',\'description\':\'GiftNFT is opensource and free.\',\'image\':\'data:image/svg+xml;utf,',byteString,'\'}'));
        return json;
    }
